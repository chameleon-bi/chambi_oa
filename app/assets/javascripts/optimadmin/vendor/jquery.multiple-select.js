...
(function($) {
    ...
    MultipleSelect.prototype = {
        ...
        update: function() {
            ...
            // CHANGED: 13/04/16 - show 'None' rather than 'All selected' when 0 results
            // if (selects.length === this.$selectItems.length + this.$disableItems.length && this.options.allSelected) {
            if ((this.$selectItems.length + this.$disableItems.length) >= 1 && selects.length === this.$selectItems.length + this.$disableItems.length && this.options.allSelected) {
            ...
            } else if (this.$selectItems.length + this.$disableItems.length === 0) {
              $span.addClass('placeholder').html('No options available');
            } else {
